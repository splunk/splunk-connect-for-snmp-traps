...
class TestHecConfiguration(TestCase):
    def setUp(self):
        env_vars = (
            HecConfiguration.endpoints_env_variable_name,
    ...
    def test_only_hec_endpoints_defined(self):
        os.environ[
            HecConfiguration.endpoints_env_variable_name
        ] = "http://127.0.0.1:8088/services/hec"
        self.assertRaises(ValueError, HecConfiguration)
    ...
    def test_all_environment_variables_defined_multiple_urls(self):
        os.environ[HecConfiguration.endpoints_env_variable_name] = (
            "http://127.0.0.1:8088/services/hec1   "
